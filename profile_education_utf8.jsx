...
const WORK_OPTIONS = ['Private Sector', 'Government/Public Sector', 'Civil Service', 'Defense', 'Business/Self Employed', 'Not Working'];
const EMPLOYMENT_TYPE = ['Full-time', 'Part-time', 'Contract', 'Freelance'];
const OCCUPATIONS = ['Software Engineer', 'Doctor', 'Teacher', 'Banker', 'Engineer', 'Other'];
const INCOME_OPTIONS = ['0 - 3 Lakhs', '3 - 6 Lakhs', '6 - 10 Lakhs', '10 - 15 Lakhs', '15+ Lakhs'];
...
const EducationCareerDetails = ({ navigation }) => {
    ...
    const handleNext = () => {
        ...
        const { education, workDetails, employmentType, occupation, annualIncome } = formData;
        const newErrors = {};
        ...
        if (!employmentType) newErrors.employmentType = 'Please select your employment type';
        if (!occupation) newErrors.occupation = 'Please select your occupation';
        if (!annualIncome) newErrors.annualIncome = 'Please select your annual income';
